...
public class AmbilWarnaPreference extends Preference {
	...
	public AmbilWarnaPreference(Context context, AttributeSet attrs) {
		...
		final TypedArray ta = context.obtainStyledAttributes(attrs, yuku.ambilwarna.R.styleable.AmbilWarnaPreference);
		supportsAlpha = ta.getBoolean(yuku.ambilwarna.R.styleable.AmbilWarnaPreference_supportsAlpha, false);
    ...
    protected void onBindView(View view) {
		...
		final View box = view.findViewById(yuku.ambilwarna.R.id.ambilwarna_pref_widget_box);
	...
	private static class SavedState extends BaseSavedState {
		...
		@SuppressWarnings("unused") public static final Creator<SavedState> CREATOR = new Creator<AmbilWarnaPreference.SavedState>() {
			public AmbilWarnaPreference.SavedState createFromParcel(Parcel in) {
				return new AmbilWarnaPreference.SavedState(in);
			}

			public AmbilWarnaPreference.SavedState[] newArray(int size) {
				return new AmbilWarnaPreference.SavedState[size];
			}
		};
	}
}
